                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-informasi.php?id=<?= $p['id'] ?>" title="Edit Data"><i class="fa-solid fa-pen-to-square"></i></a> |
                                            <a href="hapus.php?idinformasi=<?= $p['id'] ?>" onclick="return confirm('Yakin ingin di Hapus ?')"title="Hapus Data"><i class="fa-solid fa-trash"></i></a>
                                        </td>
